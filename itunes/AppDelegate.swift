...
//        let listViewController = self.window!.rootViewController as! ListViewController
        let navigationController = self.window!.rootViewController as! UINavigationController
        let listViewController = navigationController.topViewController as! ListViewController
        ListConfigurator.sharedInstance.configure(viewController: listViewController)
    }
